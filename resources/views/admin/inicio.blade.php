                            ...
                            <div class="page-header">
	                            <div class="d-flex align-items-center">
	                                ...
	                                <div class="page-header-tools">
	                                    <a class="btn btn-gradient-01" href="{{ route('admin.registro') }}">Add Widget</a>
	                                </div>
	                                </div>
	                            </div>
                            </div>
                                    ...
                                    <div class="widget-body">
                                        <div class="media">
                                            ...
                                            <div class="media-body align-self-center">
                                                <div class="title text-facebook">Coordinadores</div>
                                                <div class="number">{{$coordinador}} Miembros</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget widget-12 has-shadow">
                                    <div class="widget-body">
                                        <div class="media">
                                            ...
                                            <div class="media-body align-self-center">
                                                <div class="title text-twitter">Jugadores</div>
                                                <div class="number">{{$jugador}} Miembros</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget widget-12 has-shadow">
                                    <div class="widget-body">
                                        <div class="media">
                                            ...
                                            <div class="media-body align-self-center">
                                                <div class="title text-linkedin">Administradores</div>
                                                <div class="number">{{$admin}} Miembros</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
